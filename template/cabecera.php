...
<html>
		...
		<div id="page-wrapper">
                    <div id="header-wrapper" class="wrapper" style="position: fixed; z-index: 10000; width: 100%; background-color: whitesmoke;">
                                    ...
                                    <div id="fechaPrincipal" ><label><?PHP setlocale(LC_ALL,"es_ES");
                                            ...
                                            &nbsp;&nbsp;<a target="_blank" href="https://www.facebook.com/UVfutbolamericano"><img src="http://localhost/fuvAniversario/assets/css/images/twett.png" onmouseover="this.src='http://localhost/fuvAniversario/assets/css/images/twett-hover.png'" onmouseout="this.src='http://localhost/fuvAniversario/assets/css/images/twett.png'"></a>
                                                                                ...
                                                                                <ul class="container centrados" >
                                                                                    <div id="divMenu" class="container" >
                                                                                        ...
                                                                                        <tr><td><li type= disc><a href="http://localhost/fuvAniversario/que_hacemos/becas/?tipo=1">Programa de becas</a></li>
                                                                                                <li type= disc><a href="http://localhost/fuvAniversario/que_hacemos/becas/?tipo=2">Campañas de donativo</a></li>
                                                                                                <!-- <li type= disc><a>Testimonios</a></li> -->
                                                                                                <li type= disc><a href="http://localhost/fuvAniversario/que_hacemos/becas/?tipo=4">Convocatoria y Resultados</a></li></td></tr>   
                                                                                        </table>
                                                                                    ...
                                                                                    <table>
                                                                                       <tr><th><li><a href="http://localhost/fuvAniversario/que_hacemos/ofrecemos/">Ofrecemos espacios para eventos</a></li></th></tr>
                                                                                        <tr><td><li type= disc><a href="http://localhost/fuvAniversario/que_hacemos/ofrecemos/?tipo=1">Tlaqn&aacute;. Centro cultural</a></li>
                                                                                                <li type= disc><a href="http://localhost/fuvAniversario/que_hacemos/ofrecemos/?tipo=2">Campo de beisbol</a></li>
                                                                                                <li type= disc><a href="http://localhost/fuvAniversario/que_hacemos/ofrecemos/?tipo=3">Gimnasio universitario</a></li>
                                                                                       </td></tr>
                                                                                         </table>
                                                                                    ...
                                                                                    <table>
                                                                                        ...
                                                                                        <tr><td>
                                                                                                ...
                                                                                                <li type= disc><a href="http://localhost/fuvAniversario/que_hacemos/fomentamos/?tipo=2">Centros de formaci&oacute;n DEPORTIVA INFANTIL Y JUVENIL</a></li>
                                                                                                <li type= disc><a href="http://localhost/fuvAniversario/que_hacemos/fomentamos/?tipo=3">Programa de Futbol Americano</a></li>
                                                                                        </td></tr>
                                                                                                     </table>
                                                                                    ...
                                                                                    <div id="divMenu" class="container" >
                                                                                        ...
                                                                                        <tr><td><li type= disc><a href="http://localhost/fuvAniversario/que_hacemos/administramos/?tipo=1">Campus CAD Xalapa</a></li>
                                                                                                <li type= disc><a href="http://localhost/fuvAniversario/que_hacemos/administramos/?tipo=2">Campus IXTAC</a></li></td></tr>                                                                                        
                                                                                    </table>
                                                                                    ...
                                                                                    <table>
                                                                                        ...
                                                                                        <tr><th ><li><a href="http://localhost/fuvAniversario/que_hacemos/guiamos/">Guiamos tus proyectos</a></li></th></tr>
                                                                                        <tr><td>
                                                                                                <!-- <li type= disc><a href="http://localhost/fuvAniversario/que_hacemos/guiamos/">Gu&iacute;a para dise&ntilde;ar un proyecto</a></li>
                                                                                                <li type= disc><a href="http://localhost/fuvAniversario/que_hacemos/guiamos/">Proceso para administrar un proyecto</a></li> -->
                                                                                            </td></tr>
    ...
    <div>
        ...
        <ul id="menu"><div  id="logoResponsive" style="text-align: center; background-color: white;"><a style="background-color: white;" href="http://localhost/fuvAniversario/"><img width="100px" src="http://localhost/fuvAniversario/imagenes/principales/logo_responsive.png"></a></div>
                                        <!--<li><a href="http://localhost/fuvAniversario/">Inicio</a></li>-->
