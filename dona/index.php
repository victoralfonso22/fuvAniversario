...
<div id="contenedorBlog" class="container">
    <div  class="container">
        ...
        <div id="divSliderNotas" >                            
            ...
            <div class="glide__wrapper">
                <ul class="glide__track">
                    <li class="glide__slide"><img id="imgSliderNotas" src="img/encabezado-dona-a-becas.jpg" /></li>                    
                </ul>
            </div>
        ...
        <p id="donabecas" style="text-align: center"><a href="../donativos/aub_vn.php"><img style="margin-left: 1%" src="img/via-nomina.png"onmouseover="this.src = 'img/via-nomina-hover.png'" onmouseout="this.src = 'img/via-nomina.png'"/></a><a href="../donativos/mdn_vn.php"><img style="margin-left: 11%" src="img/via-nomina.png" onmouseover="this.src = 'img/via-nomina-hover.png'" onmouseout="this.src = 'img/via-nomina.png'"/></a></p>        
        <p id="donabecas2" style="text-align: center;font-size: 1.5em">Adopta un becario<a href="../donativos/aub_vn.php"><img src="img/via-nomina.png"onmouseover="this.src = 'img/via-nomina-hover.png'" onmouseout="this.src = 'img/via-nomina.png'"/></a><a href="../donativos/tcd.php"><img src="img/Con-tarjeta.png" onmouseover="this.src = 'img/Con-tarjeta-hover.png'" onmouseout="this.src = 'img/Con-tarjeta.png'" /></a></p>
