...
<div id="contenedorBlog" class="container">
    ...
    <div class="encabezadoSub">
        <img class="puntero" onclick="mostrarOcultar('centroMenos','centroMas');" style="vertical-align: middle; padding-top: .3em;" src="img/encoger-icon.png">&nbsp;&nbsp;<label>Centro de Atención para el Cáncer</label>
            ...
            <p>En el año 2013, el Instituto de Investigaciones Médico Biológicas de la Universidad Veracruzana (IIMB) se acercó a la Fundación UV para conceptualizar el proyecto <i>“Urgencia de Equipo, Urgencia de Vida”</i>, que implicaba la adquisición de un Tomógrafo y un Acelerador Lineal para sesiones de radioterapia para pacientes oncológicos veracruzanos.  El proyecto transitó por un proceso de rediseño con enfoque de procuración de fondos, estrategia 2013-2015, ejecución de la campaña y búsqueda de donantes potenciales, administración de recursos y finiquito del mismo con todas las instancias involucradas. </p>
